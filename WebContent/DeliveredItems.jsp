...
<div class="text-center" style="color: green; font-size: 24px; font-weight: bold;">Delivered Items</div>
        ...
        <table class="table table-hover table-sm">
            ...
            <tbody style="background-color: white;">
                ...
                <tr style="background-color: grey; color: white;">
                    <td colspan="7" style="text-align: center;">No Delivered Items Available</td>
                </tr>
                <%
                }
                %>

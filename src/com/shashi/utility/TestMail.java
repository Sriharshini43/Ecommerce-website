...
public class TestMail {
	public static void main(String[] args) {
		try {
			String recipient = "harshinipspk@gmail.com";
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to Harshini Electronics</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with Harshini Electronics.<br>"
					...
					+ "<span class='greenText'>Buy500</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
